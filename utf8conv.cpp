...
#ifndef _utf8conv_cpp
#define _utf8conv_cpp
...
namespace Mezzanine
{
    ...
    namespace Unicode
    {
        ...
        namespace
        {
            ...
            bool CheckAsFollowingBytes(Int32 HowMany, char* FirstChar)
            {
        ...
        Int32 GetIntFromCharacter(Int32& BytesUsed, char* CurrentCharacter)
        {
